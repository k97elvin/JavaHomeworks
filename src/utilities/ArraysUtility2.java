...
public class ArraysUtility2 {
    ...
    public static int[] uniqueElements(int[] array){
        ...
        for (int each : array) {
            ...
            if( ArraysUtility2.frequencyOfElement(array,each) == 1 ){ // if the frequency is one, the element is unique
                result = ArraysUtility2.addElement(result, each);
            }
    ...
    public static int[] removeDuplicates(int[] array){
        ...
        for (int each : array) {
            if(!ArraysUtility2.contains(result, each)){
                result = ArraysUtility2.addElement(result, each);
            }
        }
