...
public class StockMarket {
    public static void main(String[] args) {
        ...
        System.out.println(" how many total shares they have: ");
        int shares = scan.nextInt();

        boolean result = shares >= 0;

        System.out.println("enter your total value: ");
        ...
        System.out.println("Your total stock market holding is $ " + totalValue +
                " which is made up of " + shares + " shares. " + companyName + " is your company holdings");
...
StockMarket task:
        ...
        - Print in the following format:
            ...
            "Your total stock market holding is $25000 which
             is made up of 100 shares. Apple INC is your company holdings"
